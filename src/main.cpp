...
int64 nChainStartTime = 1522493621;
...
const string strMessageMagic = "QINGQIANLIUCOIN Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in QINGQIANLIUCOIN
    bool fStrictPayToScriptHash = true; // Always active in QINGQIANLIUCOIN
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "QINGQIANLIUCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector QINGQIANLIUCOIN empty mapBlockIndex QINGQIANLIUCOIN QINGQIANLIUCOIN";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x9bf6c8f01fbf40b2eeb69ecde8b5a73052b400474a917f5739978ed0ea9b5ded"));
